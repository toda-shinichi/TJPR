...
const OFFICIAL_DRIVE_CHARACTERS = {
  ...
  "04_楊紹宸": {
    ...
    "file": "04_楊紹宸.md",
    "identityRole": "弘楊集團副總兼執行董事、物流貿易事業群總經理。家族事業次要掌權者與首席智囊，掌控灰色碼頭通道與情報網絡。座車為私人鐵灰色 Audi RS7 / 公務黑色 Benz S680 配司機（絕非邁巴赫）。對外稱呼為「楊副總」或「副總」，妹妹楊慕璃稱其為「二哥」，【絕非少東】。",
    "summary": "28歲，INTP。天機坐命，對宮太陰。斯文俊秀、銳利優雅，眼神沉靜內斂但心狠手辣（「笑著送你下地獄」）。重度妹控。手錶 Blancpain Air Command。"
  },
  "05_徐宇寧": {
    "key": "05_徐宇寧",
    "name": "徐宇寧",
