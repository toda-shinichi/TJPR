...
var StorageService = (function() {
  ...
  function populateGlobalConfigsSheet() {
    ...
    var defaultConfigs = [
      ...
      ['NARRATOR_FALLBACK', CONFIG.MODELS.NARRATOR.FALLBACK || 'grok-4.6', '主筆小說敘事模型 (第一備援)', now],
      ['NARRATOR_FALLBACK_2', CONFIG.MODELS.NARRATOR.FALLBACK_2 || 'gemini-3.5-flash-lite', '主筆小說敘事模型 (第二備援)', now],
