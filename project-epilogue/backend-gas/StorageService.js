...
var StorageService = (function() {
  ...
  function populateGlobalConfigsSheet() {
    ...
    var defaultConfigs = [
      ...
      ['NARRATOR_FALLBACK', CONFIG.MODELS.NARRATOR.FALLBACK || 'mistral-large-3', '主筆小說敘事模型 (第一備援)', now],
      ['NARRATOR_FALLBACK_2', CONFIG.MODELS.NARRATOR.FALLBACK_2 || 'cognitivecomputations/dolphin-mistral-24b-venice-edition', '主筆小說敘事模型 (第二備援)', now],
