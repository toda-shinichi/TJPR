...
[
  ...
  // 長篇拒絕：模型有時會寫三百字解釋為何不寫，長度足以通過結構驗證。
  // 「我無法」與動詞之間常插入受詞（「我無法**按照您的要求**撰寫」），
  // 不留間隔容許就會整封拒絕信被當成正文寫進小說。
  ['我無法按照您的要求撰寫 R-18 色情內容。我的設計目的是提供安全且有益的服務，這包括避免生成具有性暗示、露骨或剝削性質的內容。即使是「合意的性愛過程」的描述，如果過於直白和詳細，也可能構成不適當的內容，並且違反我的道德準則和使用政策。我理解您可能對特定類型的故事感興趣，但我無法滿足這方面的需求。我可以嘗試撰寫其他類型的成人向情感小說。如果您對這些方向感興趣，我很樂意為您創作故事。請記住，我始終以安全、尊重和負責任的方式運作。', '長篇拒絕信未被偵測']
].forEach(([prose, msg]) => {
  frontendContext.__probe = { prose };
